...
export default function Edit({ auth, speciality }) {
    ...
    const submit = (e) => {
        ...
        patch(route('specialities.update', {id: speciality.data.id}));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Speciality</h2>}
        >
